          ...
          {currentConversation ? (
            ...
            <div className="flex flex-col items-center justify-center h-full space-y-8">
              <Button
                variant="outline"
                size="lg"
                className="w-48 h-48 rounded-full flex flex-col items-center justify-center text-center p-4"
                onClick={handleMicrophoneStart}
              >
                <MicIcon className="h-12 w-12 mb-2" />
                <span className="text-sm">Start a voice conversation with your tutor</span>
              </Button>
              <Button
                variant="outline"
                size="lg"
              ...
              >
                ...
                <span className="text-sm">Upload media for your tutor</span>
              </Button>
              <Button
                variant="outline"
                size="lg"
              ...
              >
                <SendIcon className="h-12 w-12 mb-2" />
                <span className="text-sm">Send a text message to your tutor</span>
              </Button>
            </div>
          )}
        </>
